  ...
  return (
    <main>
      ...
      <ProjectPage
        ...
        p2content={
          "...the large proportion of people who don't have the time or energy to regularly attend local sports clubs (or learn all the rules of a sport) and just want to move their bodies for fun!"
        }
